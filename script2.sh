#!/bin/bash
#Create one compressed files from the daily logs
...
scp -i kplabs-terraform.pem root@ec2-54-209-117-2.compute-1.amazonaws.com:/var/log/nginx/logs.tgz /mnt/c/Users/user/Desktop/Git/
